...
public:
	...
	void ScanTableSegment(DuckTransaction &transaction, idx_t row_start, idx_t count, vector<StorageIndex> &column_ids,
								 vector<LogicalType> types, TableScanType scan_type, const std::function<void(DataChunk &chunk)> &function);
